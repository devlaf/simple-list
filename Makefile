...
LIST_LIB_LINUX_CXX       = gcc
LIST_LIB_LINUX_CFLAGS    = -Wall
...
build_list:
	...
	$(LIST_LIB_LINUX_CXX) -Os -c $(LIST_LIB_SOURCES) -I $(LIST_LIB_INCLUDES) $(LIST_LIB_LINUX_CFLAGS) -o $(LIST_LIB_BUILD_DIR)/list.o;
